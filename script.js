...
new TypeIt("#teks1", {
  strings: ["Happy Birthday to the best teacher!", " ", "We want to celebrate not just your birthday, but everything you are.", "From teaching with your whole heart to managing the responsibilities of your home. You are more than a teacher to us: you cheer us up when we are down, you motivate us to do our best, you celebrate our victories, and you are honest enough to hold our ears when we are wrong.", " ", "We see your daily efforts, the struggles of running here and there, and the way you manage two of the biggest committees of the college at the same time, it truly is unimaginable."],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: ["Wishing you the happiest of birthdays!", " ", "Thank you for being such an incredible and dedicated teacher.", " ", "We appreciate everything you do for us and making TechVista interesting and for always believing in us.", " ", "We hope you have a fantastic day filled with joy and relaxation!"],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
